...
public class TestDetails {
	...
	strategy = "com.pms.entity.CustomIdGenerator",
	parameters = {@Parameter(name = CustomIdGenerator.PREFIX_PARAM, value = "TD") })
	@Column(name="TEST_ID")
	...
	public TestDetails(String testId, @NotBlank String testName, @NotBlank String result, String notes) {
		super();
		this.testId = testId;
		this.testName = testName;
		this.result = result;
