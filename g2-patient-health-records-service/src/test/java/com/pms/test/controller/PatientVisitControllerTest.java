...
import com.pms.controller.PatientVisitRestController;
...
//
//	    mockMvc.perform(
//	       delete("/api/v1/visit/{visitId}", visitId)
//	      .contentType(MediaType.APPLICATION_JSON))
//	      .andExpect(status().isBadRequest())
//	      .andExpect(result -> assertTrue(result.getResolvedException() instanceof PatientVisitException))
//	      .andExpect(result -> assertEquals("VisitId not found", result.getResolvedException().getMessage()));
//
//	  
//  }
